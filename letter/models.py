...
class Employees_Letter(models.Model):
    ...
    date = models.DateField()
    subject = models.CharField(max_length=100, null=True, blank=True)
    body_opening = models.TextField(max_length=200, null=True, blank=True)
    body_purpose = models.TextField(max_length=200, null=True, blank=True)
    ...
    place_address = models.CharField(max_length=120, null=True, blank=True)
