...
class EmployeesLetterForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if dapodik_employees_data is not None:
            dapodik_employees_name = [(item['nama'], item['nama']) for item in dapodik_employees_data]
        else:
            dapodik_employees_name = []
...
class CommonLetterForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'time_start': TimePickerInput(
                options={'format': 'HH:mm', 'showClear': True},
                attrs={'class': 'form-control', 'placeholder': 'hh:mm', 'required': True}
            ),
            'time_end': TimePickerInput(
                options={'format': 'HH:mm', 'showClear': True},
                attrs={'class': 'form-control', 'placeholder': 'hh:mm', 'required': True}
            ...
            'place_address': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Place', 'required': True}),
        }